...
export class ImageControllerService {
    ...
    protected basePath = 'http://localhost:8085/api/v1';
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findAllUrlByOwnerIds(ownerService: string, ownerIds: Array<number>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<string>>;
    public findAllUrlByOwnerIds(ownerService: string, ownerIds: Array<number>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<string>>>;
    public findAllUrlByOwnerIds(ownerService: string, ownerIds: Array<number>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<string>>>;
    public findAllUrlByOwnerIds(ownerService: string, ownerIds: Array<number>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (ownerService === null || ownerService === undefined) {
            throw new Error('Required parameter ownerService was null or undefined when calling findAllUrlByOwnerIds.');
        }
        if (ownerIds === null || ownerIds === undefined) {
            throw new Error('Required parameter ownerIds was null or undefined when calling findAllUrlByOwnerIds.');
        }
        ...
        let localVarPath = `/image/owner/${this.configuration.encodeParam({name: "ownerService", value: ownerService, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/batch/url`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findById(id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ImageResponse>;
    public findById(id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ImageResponse>>;
    public findById(id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ImageResponse>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findUrlByOwner(ownerService: string, ownerId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<string>>;
    public findUrlByOwner(ownerService: string, ownerId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<string>>>;
    public findUrlByOwner(ownerService: string, ownerId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<string>>>;
    public findUrlByOwner(ownerService: string, ownerId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (ownerService === null || ownerService === undefined) {
            throw new Error('Required parameter ownerService was null or undefined when calling findUrlByOwner.');
        }
        if (ownerId === null || ownerId === undefined) {
            throw new Error('Required parameter ownerId was null or undefined when calling findUrlByOwner.');
        }
        ...
        let localVarPath = `/image/owner/${this.configuration.encodeParam({name: "ownerService", value: ownerService, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/${this.configuration.encodeParam({name: "ownerId", value: ownerId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}/url`;
        return this.httpClient.request<Array<string>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
    ...
    public updateImage(type: 'PROFILE_PIC' | 'BUILD_THUMBNAIL' | 'BUILD_IMAGE' | 'RES_IMAGE', name: string, file: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (file === null || file === undefined) {
            throw new Error('Required parameter file was null or undefined when calling updateImage.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public uploadBuildImages(name: string, files: Array<Blob>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<object>;
    public uploadBuildImages(name: string, files: Array<Blob>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public uploadBuildImages(name: string, files: Array<Blob>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public uploadBuildImages(name: string, files: Array<Blob>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (name === null || name === undefined) {
            throw new Error('Required parameter name was null or undefined when calling uploadBuildImages.');
        }
        if (files === null || files === undefined) {
            throw new Error('Required parameter files was null or undefined when calling uploadBuildImages.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public uploadImage(type: 'PROFILE_PIC' | 'BUILD_THUMBNAIL' | 'BUILD_IMAGE' | 'RES_IMAGE', name: string, file: Blob, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<object>;
    public uploadImage(type: 'PROFILE_PIC' | 'BUILD_THUMBNAIL' | 'BUILD_IMAGE' | 'RES_IMAGE', name: string, file: Blob, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<object>>;
    public uploadImage(type: 'PROFILE_PIC' | 'BUILD_THUMBNAIL' | 'BUILD_IMAGE' | 'RES_IMAGE', name: string, file: Blob, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<object>>;
    public uploadImage(type: 'PROFILE_PIC' | 'BUILD_THUMBNAIL' | 'BUILD_IMAGE' | 'RES_IMAGE', name: string, file: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (type === null || type === undefined) {
